...
public class Connect4Constants {
	...
	public final static int TOKENS_TO_WIN=4;
	public final static int WINNING_SETS=69;
	...
	public final static String CHOOSE_COL_STR = 	"YOUR TURN! Enter a value from 1 to "+COLUMNS+".";
	...
	public final static String HELP_STR = 			"WELCOME TO THE CONNECT4 HELP SECTION\n\n" 
													...
													+"other WINS!!!!\n\n"
													+"How to play:\n"
													+"Enter a number from 1 to "+COLUMNS +" to drop a token \n"
